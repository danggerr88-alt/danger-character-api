...
character_names = {
    ...
    "4203": "Awaken Andrew", "4806": "Awaken Moco", "3203": "Awaken Hayato", "2506": "Awaken Kelly",
    "22016": "Awaken Alok", "506": "Nikita", "1906": "A124", "7406": "Oscar", "1206": "Wukong",
    "106": "Olivia", "7706": "Morse", "7606": "Nero",
}
...
# Add extra PNGs like primis, nulla
extra_png_names = {"102000004": "primis", "101000004": "nulla"}
png_basename_to_display.update(extra_png_names)

# Path to pngs folder (assuming pngs is at project root)
...
def get_character_image(id):
    ...
    try:
        return send_file(image_path, mimetype='image/png', as_attachment=False, download_name=f"{display_name}.png")
    except TypeError:
        return send_file(image_path, mimetype='image/png', as_attachment=False, attachment_filename=f"{display_name}.png")
